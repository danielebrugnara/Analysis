void E_TOF_cuts(){
   ...
   TCutG *cut1 = new TCutG("E_TOF_m2_z1_MG1",26);
   cut1->SetVarX("MugastData.SI_E");
   cut1->SetVarY("MugastData.T_proton");
   cut1->SetTitle("Graph");
   cut1->SetFillStyle(1000);
   cut1->SetPoint(0,0.70829,-3.51246);
   cut1->SetPoint(1,1.14168,-3.06999);
   cut1->SetPoint(2,1.14168,-3.06999);
   cut1->SetPoint(3,3.17245,-4.13191);
   cut1->SetPoint(4,3.58107,-4.3089);
   cut1->SetPoint(5,4.81934,-3.86643);
   cut1->SetPoint(6,4.81934,-3.86643);
   cut1->SetPoint(7,6.51577,-3.60095);
   cut1->SetPoint(8,7.71689,-3.24698);
   cut1->SetPoint(9,8.60845,-0.592183);
   cut1->SetPoint(10,8.84372,-0.0612228);
   cut1->SetPoint(11,8.84372,-0.0612228);
   cut1->SetPoint(12,10.5401,-0.326703);
   cut1->SetPoint(13,10.5401,-0.326703);
   cut1->SetPoint(14,10.6144,-2.27356);
   cut1->SetPoint(15,9.93339,-3.86643);
   cut1->SetPoint(16,9.93339,-3.86643);
   cut1->SetPoint(17,7.39494,-7.05219);
   cut1->SetPoint(18,7.39494,-7.05219);
   cut1->SetPoint(19,5.57469,-8.2911);
   cut1->SetPoint(20,4.57169,-9.88398);
   cut1->SetPoint(21,3.43248,-12.5388);
   cut1->SetPoint(22,2.14468,-13.3352);
   cut1->SetPoint(23,1.4141,-9.6185);
   cut1->SetPoint(24,0.807351,-4.22041);
   cut1->SetPoint(25,0.70829,-3.51246);
   ...
   auto* cut2 = new TCutG("E_TOF_m1_z1_MG1",18);
   cut2->SetVarX("MugastData.SI_E");
   cut2->SetVarY("MugastData.T_proton");
   cut2->SetTitle("Graph");
   cut2->SetFillStyle(1000);
   cut2->SetPoint(0,0.733055,-2.27356);
   cut2->SetPoint(1,1.37696,-2.27356);
   cut2->SetPoint(2,3.58107,-3.77794);
   cut2->SetPoint(3,3.58107,-3.77794);
   cut2->SetPoint(4,4.79458,-3.42397);
   cut2->SetPoint(5,6.83772,-3.33547);
   cut2->SetPoint(6,6.83772,-3.33547);
   cut2->SetPoint(7,7.67974,-3.06999);
   cut2->SetPoint(8,8.32364,-1.21164);
   cut2->SetPoint(9,8.32364,-1.21164);
   cut2->SetPoint(10,8.41032,0.646724);
   cut2->SetPoint(11,7.35779,1.08919);
   cut2->SetPoint(12,7.35779,1.08919);
   cut2->SetPoint(13,4.20021,1.62015);
   cut2->SetPoint(14,2.60284,2.77056);
   cut2->SetPoint(15,2.60284,2.77056);
   cut2->SetPoint(16,0.844499,2.41659);
   cut2->SetPoint(17,0.733055,-2.27356);
   ...
   auto* cut3 = new TCutG("E_TOF_m4_z2_MG1",30);
   cut3->SetVarX("MugastData.SI_E");
   cut3->SetVarY("MugastData.T_proton");
   cut3->SetTitle("Graph");
   cut3->SetFillStyle(1000);
   cut3->SetPoint(0,0.832117,-9.97247);
   cut3->SetPoint(1,0.89403,-7.67165);
   cut3->SetPoint(2,0.89403,-7.67165);
   cut3->SetPoint(3,1.97132,-13.6892);
   cut3->SetPoint(4,2.71429,-18.1139);
   cut3->SetPoint(5,2.71429,-18.1139);
   cut3->SetPoint(6,3.79158,-18.7333);
   cut3->SetPoint(7,3.79158,-18.7333);
   cut3->SetPoint(8,5.26512,-15.1051);
   cut3->SetPoint(9,6.71389,-10.6804);
   cut3->SetPoint(10,6.71389,-10.6804);
   cut3->SetPoint(11,8.44747,-7.14069);
   cut3->SetPoint(12,8.44747,-7.14069);
   cut3->SetPoint(13,10.9859,-2.89301);
   cut3->SetPoint(14,12.5709,-1.56561);
   cut3->SetPoint(15,12.5709,-1.56561);
   cut3->SetPoint(16,19.4681,-0.857662);
   cut3->SetPoint(17,19.53,-5.6363);
   cut3->SetPoint(18,15.3942,-5.99027);
   cut3->SetPoint(19,15.3942,-5.99027);
   cut3->SetPoint(20,12.0756,-7.76014);
   cut3->SetPoint(21,9.43809,-12.1848);
   cut3->SetPoint(22,7.04823,-21.1226);
   cut3->SetPoint(23,5.28989,-28.8215);
   cut3->SetPoint(24,5.28989,-28.8215);
   cut3->SetPoint(25,3.87826,-34.7506);
   cut3->SetPoint(26,2.14468,-30.3259);
   cut3->SetPoint(27,1.1293,-18.1139);
   cut3->SetPoint(28,0.794969,-12.1848);
   cut3->SetPoint(29,0.832117,-9.97247);
   ...
   auto* cut4 = new TCutG("E_TOF_m2_z1_MG3",25);
   cut4->SetVarX("MugastData.SI_E");
   cut4->SetVarY("MugastData.T_proton");
   cut4->SetTitle("Graph");
   cut4->SetFillStyle(1000);
   cut4->SetPoint(0,0.77259,-4.70653);
   cut4->SetPoint(1,1.9853,-4.26277);
   cut4->SetPoint(2,3.41602,-3.43073);
   cut4->SetPoint(3,3.41602,-3.43073);
   cut4->SetPoint(4,4.23358,-2.9315);
   cut4->SetPoint(5,4.23358,-2.9315);
   cut4->SetPoint(6,6.27747,-3.09791);
   cut4->SetPoint(7,7.65369,-2.9315);
   cut4->SetPoint(8,8.53937,-2.43228);
   cut4->SetPoint(9,8.53937,-2.43228);
   cut4->SetPoint(10,9.11166,0.00838531);
   cut4->SetPoint(11,9.60219,0.840429);
   cut4->SetPoint(12,11.8505,0.784959);
   cut4->SetPoint(13,11.8505,0.784959);
   cut4->SetPoint(14,11.8641,-2.04399);
   cut4->SetPoint(15,10.447,-3.15338);
   cut4->SetPoint(16,10.447,-3.15338);
   cut4->SetPoint(17,7.1904,-6.64796);
   cut4->SetPoint(18,5.10564,-7.36907);
   cut4->SetPoint(19,5.10564,-7.36907);
   cut4->SetPoint(20,3.41602,-11.5848);
   cut4->SetPoint(21,2.31232,-13.4152);
   cut4->SetPoint(22,1.76728,-11.7512);
   cut4->SetPoint(23,0.895223,-6.59249);
   cut4->SetPoint(24,0.77259,-4.70653);
   ...
   auto* cut5 = new TCutG("E_TOF_m1_z1_MG3",21);
   cut5->SetVarX("MugastData.SI_E");
   cut5->SetVarY("MugastData.T_proton");
   cut5->SetTitle("Graph");
   cut5->SetFillStyle(1000);
   cut5->SetPoint(0,0.77259,-3.04244);
   cut5->SetPoint(1,1.18137,-2.9315);
   cut5->SetPoint(2,1.88992,-2.87603);
   cut5->SetPoint(3,3.41602,-2.48774);
   cut5->SetPoint(4,3.41602,-2.48774);
   cut5->SetPoint(5,4.12457,-2.26587);
   cut5->SetPoint(6,5.40541,-2.54321);
   cut5->SetPoint(7,7.65369,-2.26587);
   cut5->SetPoint(8,7.65369,-2.26587);
   cut5->SetPoint(9,8.52575,-1.26741);
   cut5->SetPoint(10,8.51212,1.67247);
   cut5->SetPoint(11,7.84445,1.89435);
   cut5->SetPoint(12,7.84445,1.89435);
   cut5->SetPoint(13,5.52804,1.617);
   cut5->SetPoint(14,4.27445,1.83888);
   cut5->SetPoint(15,3.25251,2.28264);
   cut5->SetPoint(16,3.25251,2.28264);
   cut5->SetPoint(17,1.22225,2.61545);
   cut5->SetPoint(18,1.22225,2.61545);
   cut5->SetPoint(19,0.758964,2.67092);
   cut5->SetPoint(20,0.77259,-3.04244);
   ...
   auto* cut6 = new TCutG("E_TOF_m4_z2_MG3",27);
   cut6->SetVarX("MugastData.SI_E");
   cut6->SetVarY("MugastData.T_proton");
   cut6->SetTitle("Graph");
   cut6->SetFillStyle(1000);
   cut6->SetPoint(0,1.07236,-12.4809);
   cut6->SetPoint(1,1.71278,-13.7038);
   cut6->SetPoint(2,2.44858,-15.9662);
   cut6->SetPoint(3,3.23888,-19.0846);
   cut6->SetPoint(4,3.23888,-19.0846);
   cut6->SetPoint(5,5.41903,-13.0312);
   cut6->SetPoint(6,7.57193,-8.56757);
   cut6->SetPoint(7,7.57193,-8.56757);
   cut6->SetPoint(8,9.35693,-5.20457);
   cut6->SetPoint(9,11.1147,-2.75875);
   cut6->SetPoint(10,11.1147,-2.75875);
   cut6->SetPoint(11,12.7907,-1.78042);
   cut6->SetPoint(12,13.5401,-0.557507);
   cut6->SetPoint(13,20.4484,-0.00719779);
   cut6->SetPoint(14,20.5983,-3.98166);
   cut6->SetPoint(15,17.0283,-5.02113);
   cut6->SetPoint(16,12.7362,-5.57144);
   cut6->SetPoint(17,10.8149,-8.62872);
   cut6->SetPoint(18,9.11166,-12.6032);
   cut6->SetPoint(19,7.20403,-18.3509);
   cut6->SetPoint(20,5.58254,-24.8934);
   cut6->SetPoint(21,3.70217,-31.008);
   cut6->SetPoint(22,2.50308,-29.7239);
   cut6->SetPoint(23,1.44026,-24.8323);
   cut6->SetPoint(24,0.908849,-19.0846);
   cut6->SetPoint(25,0.908849,-19.0846);
   cut6->SetPoint(26,1.07236,-12.4809);
   ...
   auto* cut7 = new TCutG("E_TOF_m2_z1_MG4",24);
   cut7->SetVarX("MugastData.SI_E");
   cut7->SetVarY("MugastData.T_proton");
   cut7->SetTitle("Graph");
   cut7->SetFillStyle(1000);
   cut7->SetPoint(0,1.04511,-6.71889);
   cut7->SetPoint(1,1.99892,-5.85201);
   cut7->SetPoint(2,1.99892,-5.85201);
   cut7->SetPoint(3,2.93911,-4.2421);
   cut7->SetPoint(4,3.63404,-3.49907);
   cut7->SetPoint(5,5.10564,-2.81796);
   cut7->SetPoint(6,6.8225,-2.26068);
   cut7->SetPoint(7,6.8225,-2.26068);
   cut7->SetPoint(8,7.28579,-2.13684);
   cut7->SetPoint(9,8.40311,0.2161);
   cut7->SetPoint(10,11.101,-0.279256);
   cut7->SetPoint(11,11.4281,-1.33189);
   cut7->SetPoint(12,11.4281,-1.33189);
   cut7->SetPoint(13,11.1283,-2.81796);
   cut7->SetPoint(14,8.08972,-4.2421);
   cut7->SetPoint(15,7.04052,-5.29474);
   cut7->SetPoint(16,7.04052,-5.29474);
   cut7->SetPoint(17,4.05644,-9.9387);
   cut7->SetPoint(18,2.58484,-16.0687);
   cut7->SetPoint(19,2.14881,-15.2638);
   cut7->SetPoint(20,2.14881,-15.2638);
   cut7->SetPoint(21,1.44026,-12.1678);
   cut7->SetPoint(22,1.44026,-12.1678);
   cut7->SetPoint(23,1.04511,-6.71889);
   ...
   auto* cut8 = new TCutG("E_TOF_m1_z1_MG4",17);
   cut8->SetVarX("MugastData.SI_E");
   cut8->SetVarY("MugastData.T_proton");
   cut8->SetTitle("Graph");
   cut8->SetFillStyle(1000);
   cut8->SetPoint(0,1.05873,-2.07492);
   cut8->SetPoint(1,1.01786,-5.4805);
   cut8->SetPoint(2,1.01786,-5.4805);
   cut8->SetPoint(3,3.12988,-3.25139);
   cut8->SetPoint(4,4.71048,-2.3226);
   cut8->SetPoint(5,4.71048,-2.3226);
   cut8->SetPoint(6,7.16315,-1.88916);
   cut8->SetPoint(7,7.62643,-1.14613);
   cut8->SetPoint(8,7.62643,-1.14613);
   cut8->SetPoint(9,7.51743,1.14489);
   cut8->SetPoint(10,6.41373,1.33065);
   cut8->SetPoint(11,4.71048,1.39257);
   cut8->SetPoint(12,3.4024,2.01177);
   cut8->SetPoint(13,3.4024,2.01177);
   cut8->SetPoint(14,1.42663,1.14489);
   cut8->SetPoint(15,1.05873,0.897214);
   cut8->SetPoint(16,1.05873,-2.07492);
   ...
   //auto* cut9 = new TCutG("E_TOF_m2_z1_MG5",15);
   //cut9->SetVarX("MugastData.SI_E");
   //cut9->SetVarY("MugastData.T_proton");
   //cut9->SetTitle("Graph");
   //cut9->SetFillStyle(1000);
   //cut9->SetPoint(0,0.536877,-2.11481);
   //cut9->SetPoint(1,0.900862,-11.7135);
   //cut9->SetPoint(2,2.38713,-14.5601);
   //cut9->SetPoint(3,4.02506,-10.7893);
   //cut9->SetPoint(4,8.24122,-4.78238);
   //cut9->SetPoint(5,9.42417,-3.34481);
   //cut9->SetPoint(6,12.336,-0.599329);
   //cut9->SetPoint(7,9.15118,0.181373);
   //cut9->SetPoint(8,9.15118,0.181373);
   //cut9->SetPoint(9,8.36255,-0.920795);
   //cut9->SetPoint(10,7.48292,-1.56373);
   //cut9->SetPoint(11,5.35967,-1.38003);
   //cut9->SetPoint(12,3.05444,-1.74742);
   //cut9->SetPoint(13,0.567209,-1.7015);
   //cut9->SetPoint(14,0.536877,-2.11481);
   TCutG *cut9 = new TCutG("E_TOF_m2_z1_MG5",15);
   cut9->SetVarX("MugastData.SI_E");
   cut9->SetVarY("MugastData.T_proton");
   cut9->SetTitle("Graph");
   cut9->SetFillStyle(1000);
   cut9->SetPoint(0,0.353306,-2.19652);
   cut9->SetPoint(1,0.706611,-11.8327);
   cut9->SetPoint(2,2.19835,-14.6623);
   cut9->SetPoint(3,4.73037,-7.16756);
   cut9->SetPoint(4,8.04752,-4.87323);
   cut9->SetPoint(5,9.24483,-3.49664);
   cut9->SetPoint(6,12.1498,-0.743453);
   cut9->SetPoint(7,8.97004,0.0977985);
   cut9->SetPoint(8,8.97004,0.0977985);
   cut9->SetPoint(9,8.18492,-1.04936);
   cut9->SetPoint(10,7.38017,-3.19073);
   cut9->SetPoint(11,4.06302,-3.9555);
   cut9->SetPoint(12,2.8657,-1.89061);
   cut9->SetPoint(13,0.372934,-1.81414);
   cut9->SetPoint(14,0.353306,-2.19652);
   ...
   auto* cut10 = new TCutG("E_TOF_m1_z1_MG5",17);
   cut10->SetVarX("MugastData.SI_E");
   cut10->SetVarY("MugastData.T_proton");
   cut10->SetTitle("Graph");
   cut10->SetFillStyle(1000);
   cut10->SetPoint(0,0.597541,-1.44518);
   cut10->SetPoint(1,0,0);
   cut10->SetPoint(2,0.627873,1.37861);
   cut10->SetPoint(3,2.75112,1.84069);
   cut10->SetPoint(4,4.44971,1.84069);
   cut10->SetPoint(5,6.2393,1.89203);
   cut10->SetPoint(6,6.2393,1.89203);
   cut10->SetPoint(7,8.6052,0.865196);
   cut10->SetPoint(8,8.42321,-0.521027);
   cut10->SetPoint(9,8.42321,-0.521027);
   cut10->SetPoint(10,7.42225,-1.39383);
   cut10->SetPoint(11,5.96632,-1.29115);
   cut10->SetPoint(12,5.96632,-1.29115);
   cut10->SetPoint(13,5.14735,-1.18847);
   cut10->SetPoint(14,3.23643,-1.54786);
   cut10->SetPoint(15,1.05252,-1.54786);
   cut10->SetPoint(16,0.597541,-1.44518);
   ...
   //auto* cut11 = new TCutG("E_TOF_m4_z2_MG5",29);
   //cut11->SetVarX("MugastData.SI_E");
   //cut11->SetVarY("MugastData.T_proton");
   //cut11->SetTitle("Graph");
   //cut11->SetFillStyle(1000);
   //cut11->SetPoint(0,0.749202,-11.6739);
   //cut11->SetPoint(1,1.6895,-13.4727);
   //cut11->SetPoint(2,2.3568,-15.2714);
   //cut11->SetPoint(3,2.3568,-15.2714);
   //cut11->SetPoint(4,2.96344,-17.1344);
   //cut11->SetPoint(5,6.08764,-9.55395);
   //cut11->SetPoint(6,6.08764,-9.55395);
   //cut11->SetPoint(7,8.33222,-5.69946);
   //cut11->SetPoint(8,10.2431,-3.57949);
   //cut11->SetPoint(9,11.9721,-1.78073);
   //cut11->SetPoint(10,14.4896,-0.881346);
   //cut11->SetPoint(11,14.4896,-0.881346);
   //cut11->SetPoint(12,18.8574,-1.2668);
   //cut11->SetPoint(13,18.3721,-5.05704);
   //cut11->SetPoint(14,18.3721,-5.05704);
   //cut11->SetPoint(15,13.8527,-4.80008);
   //cut11->SetPoint(16,11.5474,-8.65457);
   //cut11->SetPoint(17,9.60616,-12.8303);
   //cut11->SetPoint(18,7.8469,-17.6484);
   //cut11->SetPoint(19,6.4213,-25.2931);
   //cut11->SetPoint(20,6.4213,-25.2931);
   //cut11->SetPoint(21,4.6317,-30.8179);
   //cut11->SetPoint(22,3.29709,-33.516);
   //cut11->SetPoint(23,3.29709,-33.516);
   //cut11->SetPoint(24,1.78049,-29.4046);
   //cut11->SetPoint(25,0.597541,-22.5307);
   //cut11->SetPoint(26,0.597541,-22.5307);
   //cut11->SetPoint(27,0.415549,-17.3272);
   //cut11->SetPoint(28,0.749202,-11.6739);
   auto* cut11 = new TCutG("E_TOF_m4_z2_MG5",29);
   cut11->SetVarX("MugastData.SI_E");
   cut11->SetVarY("MugastData.T_proton");
   cut11->SetTitle("Graph");
   cut11->SetFillStyle(1000);
   cut11->SetPoint(0,0.706611,-12.0621);
   cut11->SetPoint(1,1.64876,-13.8976);
   cut11->SetPoint(2,2.31612,-15.6565);
   cut11->SetPoint(3,2.31612,-15.6565);
   cut11->SetPoint(4,2.90496,-17.5685);
   cut11->SetPoint(5,6.04545,-9.99722);
   cut11->SetPoint(6,6.04545,-9.99722);
   cut11->SetPoint(7,8.28306,-6.09687);
   cut11->SetPoint(8,10.187,-4.03198);
   cut11->SetPoint(9,11.9143,-2.19652);
   cut11->SetPoint(10,14.4463,-1.27879);
   cut11->SetPoint(11,14.4463,-1.27879);
   cut11->SetPoint(12,18.8037,-1.66118);
   cut11->SetPoint(13,18.3326,-5.48505);
   cut11->SetPoint(14,18.3326,-5.48505);
   cut11->SetPoint(15,13.7986,-5.25562);
   cut11->SetPoint(16,11.5021,-9.07949);
   cut11->SetPoint(17,9.55888,-13.2857);
   cut11->SetPoint(18,7.79236,-18.1038);
   cut11->SetPoint(19,6.37913,-25.7516);
   cut11->SetPoint(20,6.37913,-25.7516);
   cut11->SetPoint(21,4.57335,-31.2579);
   cut11->SetPoint(22,3.23864,-33.9346);
   cut11->SetPoint(23,3.23864,-33.9346);
   cut11->SetPoint(24,1.72727,-29.8049);
   cut11->SetPoint(25,0.549587,-22.9219);
   cut11->SetPoint(26,0.549587,-22.9219);
   cut11->SetPoint(27,0.372934,-17.7214);
   cut11->SetPoint(28,0.706611,-12.0621);
   ...
   auto* cut12 = new TCutG("E_TOF_m2_z1_MG7",25);
   cut12->SetVarX("MugastData.SI_E");
   cut12->SetVarY("MugastData.T_proton");
   cut12->SetTitle("Graph");
   cut12->SetFillStyle(1000);
   cut12->SetPoint(0,1.42649,-3.17237);
   cut12->SetPoint(1,1.42649,-2.86148);
   cut12->SetPoint(2,3.45725,-2.42624);
   cut12->SetPoint(3,4.064,-2.30188);
   cut12->SetPoint(4,8.11314,-2.11535);
   cut12->SetPoint(5,8.11314,-2.11535);
   cut12->SetPoint(6,8.71989,-0.685268);
   cut12->SetPoint(7,8.71989,-0.685268);
   cut12->SetPoint(8,9.1409,0.496104);
   cut12->SetPoint(9,11.7908,-0.560913);
   cut12->SetPoint(10,11.7908,-0.560913);
   cut12->SetPoint(11,12.9176,-1.18269);
   cut12->SetPoint(12,12.9176,-1.18269);
   cut12->SetPoint(13,12.8433,-2.61277);
   cut12->SetPoint(14,9.51238,-3.48326);
   cut12->SetPoint(15,9.51238,-3.48326);
   cut12->SetPoint(16,6.83772,-8.64399);
   cut12->SetPoint(17,6.83772,-8.64399);
   cut12->SetPoint(18,4.80696,-14.0534);
   cut12->SetPoint(19,4.80696,-14.0534);
   cut12->SetPoint(20,3.4201,-21.0173);
   cut12->SetPoint(21,2.63999,-17.411);
   cut12->SetPoint(22,1.59984,-5.2864);
   cut12->SetPoint(23,1.59984,-5.2864);
   cut12->SetPoint(24,1.42649,-3.17237);
   ...
   TCutG *cut13 = new TCutG("E_TOF_m1_z1_MG7",16);
   cut13->SetVarX("MugastData.SI_E");
   cut13->SetVarY("MugastData.T_proton");
   cut13->SetTitle("Graph");
   cut13->SetFillStyle(1000);
   cut13->SetPoint(0,1.38934,1.90317);
   cut13->SetPoint(1,2.86288,2.48367);
   cut13->SetPoint(2,2.86288,2.48367);
   cut13->SetPoint(3,4.49739,1.84512);
   cut13->SetPoint(4,6.75104,1.14853);
   cut13->SetPoint(5,8.44747,0.800232);
   cut13->SetPoint(6,8.44747,0.800232);
   cut13->SetPoint(7,8.48462,-1.1154);
   cut13->SetPoint(8,8.17505,-1.812);
   cut13->SetPoint(9,8.17505,-1.812);
   cut13->SetPoint(10,6.05761,-1.812);
   cut13->SetPoint(11,4.6336,-1.98615);
   cut13->SetPoint(12,2.82573,-2.21834);
   cut13->SetPoint(13,1.35219,-2.50859);
   cut13->SetPoint(14,1.35219,-2.50859);
   cut13->SetPoint(15,1.38934,1.90317);
   ...
   auto* cut14 = new TCutG("E_TOF_m4_z2_MG7",32);
   cut14->SetVarX("MugastData.SI_E");
   cut14->SetVarY("MugastData.T_proton");
   cut14->SetTitle("Graph");
   cut14->SetFillStyle(1000);
   cut14->SetPoint(0,3.28389,-28.9157);
   cut14->SetPoint(1,2.7019,-24.9941);
   cut14->SetPoint(2,1.82273,-22.5431);
   cut14->SetPoint(3,1.5627,-24.0137);
   cut14->SetPoint(4,2.63999,-63.0333);
   cut14->SetPoint(5,2.63999,-63.0333);
   cut14->SetPoint(6,3.19721,-68.9157);
   cut14->SetPoint(7,4.08876,-68.7196);
   cut14->SetPoint(8,6.04523,-63.5235);
   cut14->SetPoint(9,7.58068,-40.8765);
   cut14->SetPoint(10,8.48462,-31.4647);
   cut14->SetPoint(11,8.48462,-31.4647);
   cut14->SetPoint(12,10.4039,-21.0725);
   cut14->SetPoint(13,12.6824,-11.5627);
   cut14->SetPoint(14,12.6824,-11.5627);
   cut14->SetPoint(15,16.6077,-6.56274);
   cut14->SetPoint(16,19.5671,-7.34706);
   cut14->SetPoint(17,19.5671,-7.34706);
   cut14->SetPoint(18,19.7033,-0.974509);
   cut14->SetPoint(19,13.8835,-1.46471);
   cut14->SetPoint(20,13.8835,-1.46471);
   cut14->SetPoint(21,12.769,-3.22941);
   cut14->SetPoint(22,10.7135,-7.15098);
   cut14->SetPoint(23,10.7135,-7.15098);
   cut14->SetPoint(24,9.02946,-12.3471);
   cut14->SetPoint(25,7.6426,-19.0137);
   cut14->SetPoint(26,7.6426,-19.0137);
   cut14->SetPoint(27,5.51277,-32.9353);
   cut14->SetPoint(28,5.51277,-32.9353);
   cut14->SetPoint(29,3.90302,-36.8569);
   cut14->SetPoint(30,3.4201,-31.2686);
   cut14->SetPoint(31,3.28389,-28.9157);
   ...
   auto* cut15 = new TCutG("E_TOF_m4_z2_MG4",35);
   cut15->SetVarX("MugastData.SI_E");
   cut15->SetVarY("MugastData.T_proton");
   cut15->SetTitle("Graph");
   cut15->SetFillStyle(1000);
   cut15->SetPoint(0,1.37213,-13.53);
   cut15->SetPoint(1,2.05343,-19.9077);
   cut15->SetPoint(2,2.05343,-19.9077);
   cut15->SetPoint(3,3.21163,-25.7901);
   cut15->SetPoint(4,3.21163,-25.7901);
   cut15->SetPoint(5,4.27445,-21.3319);
   cut15->SetPoint(6,6.16846,-13.9635);
   cut15->SetPoint(7,6.16846,-13.9635);
   cut15->SetPoint(8,8.02159,-8.76223);
   cut15->SetPoint(9,9.07078,-5.41858);
   cut15->SetPoint(10,9.07078,-5.41858);
   cut15->SetPoint(11,10.9784,-3.56099);
   cut15->SetPoint(12,13.2403,-1.57957);
   cut15->SetPoint(13,13.2403,-1.57957);
   cut15->SetPoint(14,18.3092,-1.70341);
   cut15->SetPoint(15,18.3092,-1.70341);
   cut15->SetPoint(16,18.2683,-5.1709);
   cut15->SetPoint(17,14.9844,-6.03777);
   cut15->SetPoint(18,12.4364,-6.65697);
   cut15->SetPoint(19,12.4364,-6.65697);
   cut15->SetPoint(20,10.883,-9.44334);
   cut15->SetPoint(21,9.04353,-14.0873);
   cut15->SetPoint(22,9.04353,-14.0873);
   cut15->SetPoint(23,7.1359,-21.5176);
   cut15->SetPoint(24,5.62342,-29.7529);
   cut15->SetPoint(25,4.54697,-37.8025);
   cut15->SetPoint(26,3.68854,-39.4124);
   cut15->SetPoint(27,3.68854,-39.4124);
   cut15->SetPoint(28,2.74835,-37.7406);
   cut15->SetPoint(29,1.94442,-34.4588);
   cut15->SetPoint(30,1.94442,-34.4588);
   cut15->SetPoint(31,1.304,-26.0997);
   cut15->SetPoint(32,0.976979,-18.5455);
   cut15->SetPoint(33,0.990605,-7.95728);
   cut15->SetPoint(34,1.37213,-13.53);
   ...
   auto* cut16 = new TCutG("E_TOF_m2_z1_MG11",12);
   cut16->SetVarX("MugastData.SI_E");
   cut16->SetVarY("MugastData.T_proton");
   cut16->SetTitle("Graph");
   cut16->SetFillStyle(1000);
   cut16->SetPoint(0,0.575156,-2.06989);
   cut16->SetPoint(1,3.97156,-2.16045);
   cut16->SetPoint(2,6.84734,-2.40193);
   cut16->SetPoint(3,8.3596,-1.58692);
   cut16->SetPoint(4,9.7727,0.0431115);
   cut16->SetPoint(5,12.3262,0.103483);
   cut16->SetPoint(6,12.0783,-1.07376);
   cut16->SetPoint(7,12.0783,-1.07376);
   cut16->SetPoint(8,10.7891,-2.25101);
   cut16->SetPoint(9,0.4512,-7.59389);
   cut16->SetPoint(10,0.4512,-7.59389);
   cut16->SetPoint(11,0.575156,-2.06989);
   ...
   auto* cut17 = new TCutG("E_TOF_m1_z1_MG11",13);
   cut17->SetVarX("MugastData.SI_E");
   cut17->SetVarY("MugastData.T_proton");
   cut17->SetTitle("Graph");
   cut17->SetFillStyle(1000);
   cut17->SetPoint(0,0.599948,-1.91896);
   cut17->SetPoint(1,3.94676,-1.97933);
   cut17->SetPoint(2,6.84734,-2.31138);
   cut17->SetPoint(3,8.3596,-1.49636);
   cut17->SetPoint(4,9.20251,-0.439861);
   cut17->SetPoint(5,9.20251,-0.439861);
   cut17->SetPoint(6,7.49191,1.19017);
   cut17->SetPoint(7,7.49191,1.19017);
   cut17->SetPoint(8,5.63257,1.1298);
   cut17->SetPoint(9,2.78158,1.49203);
   cut17->SetPoint(10,0.723904,1.25054);
   cut17->SetPoint(11,0.723904,1.25054);
   cut17->SetPoint(12,0.599948,-1.91896);
   ...
   auto* cut18 = new TCutG("E_TOF_m4_z2_MG11",11);
   cut18->SetVarX("MugastData.SI_E");
   cut18->SetVarY("MugastData.T_proton");
   cut18->SetTitle("Graph");
   cut18->SetFillStyle(1000);
   cut18->SetPoint(0,0.4512,-7.86556);
   cut18->SetPoint(1,7.91336,-4.00178);
   cut18->SetPoint(2,11.4337,-2.06989);
   cut18->SetPoint(3,11.4337,-2.06989);
   cut18->SetPoint(4,14.9045,0.616641);
   cut18->SetPoint(5,19.3173,0.314783);
   cut18->SetPoint(6,19.3173,0.314783);
   cut18->SetPoint(7,18.5736,-2.16045);
   cut18->SetPoint(8,8.88022,-6.77887);
   cut18->SetPoint(9,0.550365,-11.4577);
   cut18->SetPoint(10,0.4512,-7.86556);
