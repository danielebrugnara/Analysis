void E_TOF_cuts(){
   ...
   auto *cut5 = new TCutG("E_TOF_m1_z1_MG3",40);
   cut5->SetVarX("E vs TOF of MG3");
   cut5->SetVarY("");
   cut5->SetTitle("Graph");
   cut5->SetFillStyle(1000);
   cut5->SetPoint(0,1.14517,316.043);
   cut5->SetPoint(1,1.32136,322.783);
   cut5->SetPoint(2,1.45119,326.725);
   cut5->SetPoint(3,1.76648,332.957);
   cut5->SetPoint(4,2.09105,338.171);
   cut5->SetPoint(5,2.87,347.2);
   cut5->SetPoint(6,3.27803,350.761);
   cut5->SetPoint(7,3.68605,353.177);
   cut5->SetPoint(8,4.17754,354.83);
   cut5->SetPoint(9,5.12342,356.483);
   cut5->SetPoint(10,6.06002,357.501);
   cut5->SetPoint(11,7.04299,358.518);
   cut5->SetPoint(12,7.8034,359.281);
   cut5->SetPoint(13,8.26706,359.535);
   cut5->SetPoint(14,8.4618,360.553);
   cut5->SetPoint(15,8.38762,362.46);
   cut5->SetPoint(16,7.51593,362.206);
   cut5->SetPoint(17,6.08784,361.697);
   cut5->SetPoint(18,5.42016,361.697);
   cut5->SetPoint(19,4.39083,361.189);
   cut5->SetPoint(20,3.61187,361.189);
   cut5->SetPoint(21,2.9071,360.298);
   cut5->SetPoint(22,2.44343,359.281);
   cut5->SetPoint(23,2.54544,357.882);
   cut5->SetPoint(24,2.81437,358.009);
   cut5->SetPoint(25,3.6026,358.772);
   cut5->SetPoint(26,3.87152,358.645);
   cut5->SetPoint(27,3.41713,358.009);
   cut5->SetPoint(28,2.75873,353.304);
   cut5->SetPoint(29,2.42489,349.235);
   cut5->SetPoint(30,2.04468,344.021);
   cut5->SetPoint(31,1.72012,338.934);
   cut5->SetPoint(32,1.4141,333.338);
   cut5->SetPoint(33,1.21008,325.962);
   cut5->SetPoint(34,1.03389,319.095);
   cut5->SetPoint(35,0.987526,315.789);
   cut5->SetPoint(36,1.00607,313.881);
   cut5->SetPoint(37,1.1359,315.153);
   cut5->SetPoint(38,1.12663,316.17);
   cut5->SetPoint(39,1.14517,316.043);
