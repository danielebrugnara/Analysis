void E_TOF_cuts(){
   ...
   auto *cut4 = new TCutG("E_TOF_m1_z1_MG3",42);
   ...
   auto* cut5 = new TCutG("E_TOF_m2_z1_MG3",41);
   cut5->SetVarX("E vs TOF of MG3");
   cut5->SetVarY("");
   cut5->SetTitle("Graph");
   cut5->SetFillStyle(1000);
   cut5->SetPoint(0,1.04564,312.631);
   cut5->SetPoint(1,1.17228,315.852);
   cut5->SetPoint(2,1.29892,321.098);
   cut5->SetPoint(3,1.44366,325.515);
   cut5->SetPoint(4,1.54316,328);
   cut5->SetPoint(5,1.82358,333.246);
   cut5->SetPoint(6,2.14019,338.492);
   cut5->SetPoint(7,2.76436,345.486);
   cut5->SetPoint(8,2.98146,347.787);
   cut5->SetPoint(9,3.38852,351.193);
   cut5->SetPoint(10,3.92223,353.585);
   cut5->SetPoint(11,5.05297,355.978);
   cut5->SetPoint(12,6.95261,358.003);
   cut5->SetPoint(13,8.26426,359.383);
   cut5->SetPoint(14,8.63514,360.672);
   cut5->SetPoint(15,9.08744,361.592);
   cut5->SetPoint(16,10.2815,361.5);
   cut5->SetPoint(17,10.6071,361.408);
   cut5->SetPoint(18,11.1137,361.316);
   cut5->SetPoint(19,11.5298,361.224);
   cut5->SetPoint(20,11.5298,359.66);
   cut5->SetPoint(21,11.0142,358.923);
   cut5->SetPoint(22,10.7157,358.463);
   cut5->SetPoint(23,10.4805,358.279);
   cut5->SetPoint(24,10.3629,358.371);
   cut5->SetPoint(25,9.07839,357.635);
   cut5->SetPoint(26,7.92052,355.702);
   cut5->SetPoint(27,7.16066,355.15);
   cut5->SetPoint(28,6.57268,354.414);
   cut5->SetPoint(29,5.66809,353.125);
   cut5->SetPoint(30,4.80873,351.561);
   cut5->SetPoint(31,4.18456,349.996);
   cut5->SetPoint(32,3.66895,347.787);
   cut5->SetPoint(33,3.09001,343.002);
   cut5->SetPoint(34,2.64676,336.743);
   cut5->SetPoint(35,2.07687,329.381);
   cut5->SetPoint(36,1.60648,321.558);
   cut5->SetPoint(37,1.33511,315.576);
   cut5->SetPoint(38,1.16323,312.539);
   cut5->SetPoint(39,1.00945,310.974);
   cut5->SetPoint(40,1.04564,312.631);
