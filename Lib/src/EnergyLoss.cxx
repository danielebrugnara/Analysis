...
double EnergyLoss::Eval(double energy) const{
    if (energy < 0)
        throw std::runtime_error("\033[1;31mERROR: negative energy given to EnergyLoss\033[0m\n");
    else if (energy != energy)
        throw std::runtime_error("\033[1;31mERROR: nan energy given to EnergyLoss\033[0m\n");
