...
private: //Constants used internally
    ...
    std::array<std::pair<double, double>, 100> beamPositions;
    ...
    //};
    std::array<std::pair<double, double>, 100> focusScale;
    //const std::array<std::pair<double, double>, 32> focusScale =
    //                                            { std::make_pair( 1.10, 0.), std::make_pair( 1.03, 0.), std::make_pair( 0.96, 0.), std::make_pair( 0.89, 0.), std::make_pair( 0.82, 0.), std::make_pair( 0.75, 0.), std::make_pair( 0.68, 0.), std::make_pair( 0.61, 0.), std::make_pair( //0 - 7
    //                                             0.54, 0.), std::make_pair( 0.47, 0.), std::make_pair( 0.40, 0.), std::make_pair( 0.33, 0.), std::make_pair( 0.26, 0.), std::make_pair( 0.19, 0.), std::make_pair( 0.12, 0.), std::make_pair( 0.05, 0.), std::make_pair( //8 - 15
    //                                            -0.02, 0.), std::make_pair(-0.09, 0.), std::make_pair(-0.16, 0.), std::make_pair(-0.23, 0.), std::make_pair(-0.30, 0.), std::make_pair(-0.37, 0.), std::make_pair(-0.44, 0.), std::make_pair(-0.51, 0.), std::make_pair( //16- 23
    //                                            -0.58, 0.), std::make_pair(-0.65, 0.), std::make_pair(-0.72, 0.), std::make_pair(-0.79, 0.), std::make_pair(-0.86, 0.), std::make_pair(-0.93, 0.), std::make_pair(-1.00, 0.), std::make_pair(-1.07, 0.)};//24- 31
...
private: //Variables used internally
    ...
    std::unordered_map<int, Calibration *> calibrationsTTime;
    std::unordered_map<std::string, std::map<int,std::pair<double, double>>> particleIdInterval; //[particle name][MG] <min, max>
